...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Kiểm tra mật khẩu hiện tại nếu đổi mật khẩu
      if (formData.newPassword) {
        ...
        if (accounts[accountIndex].password !== formData.currentPassword) {
      ...
      const existingAccount = accounts.find(acc => 
        acc.email === formData.email && acc.id !== user.id
      );
      if (existingAccount) {
      ...
      if (formData.newPassword) {
        updatedAccount.password = formData.newPassword;
      }
